            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Create New Mews Service</h4>
                        <a href="{{ route('mews-services.index') }}" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('mews-services.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('data_discriminator') is-invalid @enderror" 
                                        ...
                                        <option value="Bookable" {{ old('data_discriminator') === 'Bookable' ? 'selected' : '' }}>Bookable</option>
                                        <option value="Additional" {{ old('data_discriminator') === 'Additional' ? 'selected' : '' }}>Additional</option>
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input @error('bill_as_package') is-invalid @enderror" 
                                               id="bill_as_package" name="bill_as_package" value="1" {{ old('bill_as_package') ? 'checked' : '' }}>
