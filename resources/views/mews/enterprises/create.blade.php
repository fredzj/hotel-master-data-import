            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Create New Mews Enterprise</h4>
                        <a href="{{ route('mews-enterprises.index') }}" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('mews-enterprises.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('mews_id') is-invalid @enderror" 
                                           id="mews_id" name="mews_id" value="{{ old('mews_id') }}" required>
                                    @error('mews_id')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('time_zone_identifier') is-invalid @enderror" 
                                           id="time_zone_identifier" name="time_zone_identifier" value="{{ old('time_zone_identifier') }}" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('chain_name') is-invalid @enderror" 
                                           id="chain_name" name="chain_name" value="{{ old('chain_name') }}">
                                    @error('chain_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('default_language_code') is-invalid @enderror" 
                                           id="default_language_code" name="default_language_code" value="{{ old('default_language_code') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('country_subdivision_code') is-invalid @enderror" 
                                           id="country_subdivision_code" name="country_subdivision_code" value="{{ old('country_subdivision_code') }}">
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Enterprise
                            </button>
                        </div>
                    </form>
                </div>
