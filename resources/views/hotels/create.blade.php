                    ...
                    <form method="POST" action="{{ route('hotels.store') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('pms_system_id') is-invalid @enderror" 
                                    ...
                                    @foreach($pmsSystems as $pms)
                                        <option value="{{ $pms->id }}" {{ old('pms_system_id') == $pms->id ? 'selected' : '' }}>
                                            {{ $pms->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('commercial_register_entry') is-invalid @enderror" 
                                   ...
                                   value="{{ old('commercial_register_entry') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('bank_bic') is-invalid @enderror" 
                                       id="bank_bic" name="bank_bic" value="{{ old('bank_bic') }}">
                                @error('bank_bic')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('bank_iban') is-invalid @enderror" 
                                   id="bank_iban" name="bank_iban" value="{{ old('bank_iban') }}">
                            @error('bank_iban')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary me-2">Create Hotel</button>
